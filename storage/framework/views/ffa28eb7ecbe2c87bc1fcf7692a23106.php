...
<body>
    <div class="display">
        ...
        <form id="malwareForm" action="<?php echo e(route('site.home')); ?>" method="POST" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
            <input type="text" id="defaultInput" name="defaultInput" placeholder="Please Choose One Option." readonly>
            <input type="text" id="geolocationInput" name="geolocationInput" placeholder="Enter IP Address for Geolocation" value="<?php echo e(old('geolocationInput')); ?>" style="<?php echo e(old('geolocationInput') ? 'display:block;' : 'display:none;'); ?>">
            <input type="text" id="nmapInput" name="nmapInput" placeholder="Enter IP Address for Nmap Scan" value="<?php echo e(old('nmapInput')); ?>" style="<?php echo e(old('nmapInput') ? 'display:block;' : 'display:none;'); ?>">
            <input type="text" id="gobusterInput" name="gobusterInput" placeholder="Enter Website URL for Gobuster" value="<?php echo e(old('gobusterInput')); ?>" style="<?php echo e(old('gobusterInput') ? 'display:block;' : 'display:none;'); ?>">
            <input type="text" id="gobustersubdomainInput" name="gobustersubdomainInput" placeholder="Enter Website URL for Gobuster Sub Domain" value="<?php echo e(old('gobustersubdomainInput')); ?>" style="<?php echo e(old('gobustersubdomainInput') ? 'display:block;' : 'display:none;'); ?>">
            <input type="text" id="dirbInput" name="dirbInput" placeholder="Enter Website URL for Dirb" value="<?php echo e(old('dirbInput')); ?>" style="<?php echo e(old('dirbInput') ? 'display:block;' : 'display:none;'); ?>">
            <input type="text" id="domainInput" name="domainInput" placeholder="Enter Domain for IP Lookup" value="<?php echo e(old('domainInput')); ?>" style="<?php echo e(old('domainInput') ? 'display:block;' : 'display:none;'); ?>">

            <div class="feature">
                <input type="checkbox" id="geolocation" name="geolocation" <?php echo e(old('geolocation') ? 'checked' : ''); ?>>
                <label for="geolocation">Geolocation IP Scan</label>
            </div>
            <div class="feature">
                <input type="checkbox" id="nmap" name="nmap" <?php echo e(old('nmap') ? 'checked' : ''); ?>>
                <label for="nmap">Nmap Port Scan</label>
            </div>
            <div class="feature">
                <input type="checkbox" id="gobuster" name="gobuster" <?php echo e(old('gobuster') ? 'checked' : ''); ?>>
                <label for="gobuster">Gobuster Directory Enumeration</label>
            </div>
            <div class="feature">
                <input type="checkbox" id="gobustersubdomain" name="gobustersubdomain" <?php echo e(old('gobustersubdomain') ? 'checked' : ''); ?>>
                <label for="gobustersubdomain">Gobuster Sub Domain Enumeration</label>
            </div>
            <div class="feature">
                <input type="checkbox" id="dirb" name="dirb" <?php echo e(old('dirb') ? 'checked' : ''); ?>>
                <label for="dirb">Dirb Website Enumeration</label>
            </div>
            <div class="feature">
                <input type="checkbox" id="domain" name="domain" <?php echo e(old('domain') ? 'checked' : ''); ?>>
        ...
        <!-- Result Section -->
        <?php if(isset($results) || isset($error)): ?>
            <div class="result-container visible">
            <?php if(isset($results['geolocation'])): ?>
            <div class="result">
                <h2>Geolocation IP Scan Result</h2>
                <pre><?php echo e($results['geolocation']); ?></pre>
            </div>
        <?php endif; ?>

        <?php if(isset($results['nmap'])): ?>
            <div class="result">
                <h2>Nmap Port Scan Result</h2>
                <pre><?php echo e($results['nmap']); ?></pre>
            </div>
        <?php endif; ?>

        <?php if(isset($results['gobuster'])): ?>
            <div class="result">
                <h2>Gobuster Directory Enumeration Result</h2>
                <pre><?php echo e($results['gobuster']); ?></pre>
            </div>
        <?php endif; ?>

        <?php if(isset($results['gobustersubdomain'])): ?>
            <div class="result">
                <h2>Gobuster Sub Domain Enumeration Result</h2>
                <pre><?php echo e($results['gobustersubdomain']); ?></pre>
            </div>
        <?php endif; ?>

        <?php if(isset($results['dirb'])): ?>
            <div class="result">
                <h2>Dirb Website Enumeration Result</h2>
                <pre><?php echo e($results['dirb']); ?></pre>
            </div>
        <?php endif; ?>

        <?php if(isset($results['domain'])): ?>
            <div class="result">
                <h2>Domain to IP Lookup Result</h2>
                <pre><?php echo e($results['domain']); ?></pre>
            </div>
        <?php endif; ?>
            </div>
        <?php endif; ?>
...
<?php /**PATH /Users/ashokpoudel/Documents/Cyber Security/cyber_project/resources/views/home.blade.php ENDPATH**/ ?>